...
public class MenuManager : MonoBehaviour
{
    ...
    public void LoadLocal()
    {
        ...
        optimizationSettings.initialGenotype = CreatureGenotype.LoadData("/Users/anooprehman/Downloads/arv-vesperferox (1).creature", true); // null means start w/ random creatures. TODO: Non-null will mean spawn that with mutations!
